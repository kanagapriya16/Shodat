...
import eops from "../Assets/eops.png";
function Eops() {
    return (
        <Box height={'163vh'} sx={{
            backgroundColor: "#FFFBEF",}}>
            <Grid container xs={12}>
                <Typography variant='h4' sx={{marginLeft: "4%", marginTop: "4%",fontWeight:"bold" }}>Why eOps?</Typography>
                <Box sx={{
                ...
                <Typography sx={{ marginTop: "17%", marginLeft: '-8%', fontSize: "15px" }}>this is a sample,
                    <Typography sx={{ fontSize: "15px" }}> eops logo</Typography></Typography>
            </Grid>
            <Grid container xs={12} >
                ...
                ><CheckIcon />Low/No code data ingestion, harmonization & ML
                    <Typography sx={{ marginLeft: "7%", marginTop: "1%" }}
